...
public class PopularFragment extends Fragment {
    ...
    private List<Popular.Results> resultsList = new ArrayList<>();
        ...
        public void onChanged(Popular popular) {
            ...
            ItemClickSupport.addTo(rv_popular).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_menu_popular_to_menu_movie_details, bundle);
                }
            });
